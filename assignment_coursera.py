...
def is_valid_word(wordlist, word):
    ...
    ##this would have been the code if the list was to be imported
    ##from the given file
    
##    wordlist="C:/Users/Nadia.Marra/Documents/wordlist1.txt"
##    file=open(wordlist,'r')
##    wordlist1=file.readlines()
##    file.close()
##    wordlist1=[i.rstrip() for i in wordlist1] 
##    word in wordlist1
